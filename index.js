/* BU DERSDEKİ TÜM DEĞERLERKONTROLÜ ÇALIŞMAZ */
//İN DÖNMESİNİ (RETURN) UNUTMAYIN, AKSİ TAKDİRDE TEST 
/* İşte veriniz bu */
...
function dizi25Cesitmi(veri){
if (veri.length==25){
return true
} else {
return false
}
console.log(dizi25Cesitmi(veri));
}
/* Görev 3:
...
function indekstekiCesitiGetir(dizi,sayi){
return dizi[sayi];
}
...
function ismeGoreCesitCikar(dizi,lezzet){
 let tarcın=dizi.indexOf(lezzet);
 dizi.splice(tarcın,1);
 return dizi;
}
...
console.log(ismeGoreFiltrele(orijinalTatlar,"i"));
